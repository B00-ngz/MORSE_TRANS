...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define FS        3600000.0f
#define F_TONE    1000.0f
#define TABLE_SIZE 200

#define DOT_TIME_MS 100
...
int main(void)
{
  ...
  HAL_TIM_Base_Start(&htim6);  // DAC trigger timer
...
void GenerateSine(void)
{
    for (int i = 0; i < TABLE_SIZE; i++)
    {
        ...
        float val = (sinf(2 * M_PI * t) + 1.0f) * 2047; // 12-bit DAC
